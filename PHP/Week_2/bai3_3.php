...
<html lang="en">
	<head>
		...
		<script src="ajax/js/bai3_3_ajax.js"></script>
		<script src="ajax/js/jquery.form.js"></script>
	</head>
	<body>
		<div class="box-upload">
			<h2>Upload File</h2>
			<form action="ajax/handing/bai3_3.php" method="post" enctype="multipart/form-data" id="formUpload" onsubmit="return false;">

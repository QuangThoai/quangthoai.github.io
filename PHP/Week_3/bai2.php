...
<html lang="en">
	...
	<body>
		<div class="box-upload">
			<h2>Upload File And Read File SplFileObject</h2>
			<form action="ajax/handing/bai2.php" method="post" enctype="multipart/form-data" id="formUpload" onsubmit="return false;">
